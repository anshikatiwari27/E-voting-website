...
routes.get('/givevote', (req, res) => {
    const { user } = req.session; // Get user data from the session
...
routes.get('/logout', (req, res) => {
    // Perform logout actions (e.g., clearing the session)
...
// Add this route to handle vote submission
// Add this route to handle vote submission
// Add this route to handle vote submission
...
// Add this route to handle party association and incrementing vote count
